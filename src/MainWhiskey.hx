...
class MainWhiskey {
	public function new() {
		...
		generate("export/wiskey_00010.json", 10);
		generate("export/wiskey_00100.json", 100);
		generate("export/wiskey_01000.json", 1000);
		generate("export/wiskey_10000.json", 10000);
	}

	function generate(path:String = "export/wiskey.json", total:Int = 11) {
		var json = {};
		...
		for (i in 0...total) {
			...
			Reflect.setField(obj, 'images', new Image().image('$i', 200, 500));
